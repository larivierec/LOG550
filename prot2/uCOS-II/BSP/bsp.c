...
#define     LED3_GPIO                   AVR32_PIN_PB29
#define     LED4_GPIO                   AVR32_PIN_PB30
#define     LED5_GPIO                   AVR32_PIN_PB20
#define     LED6_GPIO                   AVR32_PIN_PB22
#define     LED7_GPIO                   AVR32_PIN_PB19                  /* Red LED5                                                 */
#define     LED8_GPIO                   AVR32_PIN_PB21                  /* Red LED6                                                 */
...
{
    BSP_PM_OSC0Setup();
    BSP_PM_ClkSwitch(AVR32_PM_MCSEL_OSC0);

    BSP_PM_PLL0Setup(8, 1, 1);                                          /* Setup PLL0 to 48MHz                                      */
    BSP_PM_GClkSetup(1);                                                /* Activate Generic clock using PLL0 as source              */
    BSP_PM_ClkSelect(0, 0, 1, 0, 0, 0);                                 /* Configure PBA to half of main clock's frequency          */

    BSP_FLASHC_SetWaitState(1);                                         /* Set 1 WS to Flash Controller since HSB > 30MHz           */

    BSP_PM_ClkSwitch(AVR32_PM_MCSEL_PLL0);
...
void  LED_On (CPU_INT08U led)
{
    switch (led) {
        case 0:
             BSP_GPIO_PinClr(LED1_GPIO);
             BSP_GPIO_PinClr(LED2_GPIO);
             BSP_GPIO_PinClr(LED3_GPIO);
             BSP_GPIO_PinClr(LED4_GPIO);
             BSP_GPIO_PinClr(LED5_GPIO);
             BSP_GPIO_PinClr(LED6_GPIO);
             BSP_GPIO_PinClr(LED7_GPIO);
             BSP_GPIO_PinClr(LED8_GPIO);
             break;
...
void  LED_Off (CPU_INT08U led)
{
    switch (led) {
        case 0:
             BSP_GPIO_PinSet(LED1_GPIO);
             BSP_GPIO_PinSet(LED2_GPIO);
             BSP_GPIO_PinSet(LED3_GPIO);
             BSP_GPIO_PinSet(LED4_GPIO);
             BSP_GPIO_PinSet(LED5_GPIO);
             BSP_GPIO_PinSet(LED6_GPIO);
             BSP_GPIO_PinSet(LED7_GPIO);
             BSP_GPIO_PinSet(LED8_GPIO);
             break;
...
void  LED_Toggle (CPU_INT08U led)
{
    switch (led) {
        case 0:
             BSP_GPIO_PinTgl(LED1_GPIO);
             BSP_GPIO_PinTgl(LED2_GPIO);
             BSP_GPIO_PinTgl(LED3_GPIO);
             BSP_GPIO_PinTgl(LED4_GPIO);
             BSP_GPIO_PinTgl(LED5_GPIO);
             BSP_GPIO_PinTgl(LED6_GPIO);
             BSP_GPIO_PinTgl(LED7_GPIO);
             BSP_GPIO_PinTgl(LED8_GPIO);
             break;
