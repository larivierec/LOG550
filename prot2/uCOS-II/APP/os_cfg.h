...
* If you plan on using  uC/OS-II  in a commercial product you need to contact Micriľm to properly license
...
#define OS_TLS_TBL_SIZE           5   /* Size of Thread-Local Storage Table                           */
